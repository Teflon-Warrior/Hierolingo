...
<div class="profile-header">
            <nav id="mySidenav" class="sidenav">
                <ul>
                    ...
                    <li><a href="lesson.php<?php echo"?les=2";?>">Lessons</a></li>
...
<div class="openbtn">
                ...
                <div style="padding-top: 40px; position: absolute; left: 50%; transform: translate(-50%,0); font-size: 2em;font-family:'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif; color: black;font-weight: bold;">Quiz 2 </div>
</div>
  </header>
  <?php
  session_start();
